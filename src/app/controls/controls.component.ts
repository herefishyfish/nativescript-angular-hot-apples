...
@Component({
  ...
  template: `
    <ActionBar title="Thermal Controls" class="action-bar">
      <NavigationButton text="Back" (tap)="onBack()"></NavigationButton>
    </ActionBar>
    
    <ScrollView class="page">
      <StackLayout class="p-4">
        <Label text="Apple Event Thermal Controls" class="h1 text-center mb-4"></Label>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.effectIntensity.toFixed(2)" class="value-label"></Label>
        </StackLayout>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.colorSaturation.toFixed(2)" class="value-label"></Label>
        </StackLayout>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.heatSensitivity.toFixed(2)" class="value-label"></Label>
        </StackLayout>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.heatDecay.toFixed(3)" class="value-label"></Label>
        </StackLayout>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.interactionRadius.toFixed(2)" class="value-label"></Label>
        </StackLayout>
        ...
        <StackLayout class="control-group mb-4">
          ...
          <Label [text]="'Value: ' + controls.gradientShift.toFixed(2)" class="value-label"></Label>
        </StackLayout>
        
        <!-- Action Buttons -->
        <StackLayout class="mt-6">
          <Button text="Reset to Defaults" (tap)="resetToDefaults()" class="btn btn-outline mb-3"></Button>
          <Button text="Back to Animation" (tap)="onBack()" class="btn btn-primary"></Button>
        </StackLayout>
      </StackLayout>
    </ScrollView>
  `,
...
export class ControlsComponent {
  ...
  private saveControls() {
    try {
      ApplicationSettings.setString('thermalControls', JSON.stringify(this.controls));
    } catch (error) {
